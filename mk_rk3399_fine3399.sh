...
DAEMON_JSON="${PWD}/files/rk3399/fine3399/daemon.json"
...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3399/fine3399/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3399/fine3399"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3399/fine3399/uboot-bozz-fine3399.bin"
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3399/fine3399/board.d"
# 20221001 add
