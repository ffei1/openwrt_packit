...
# 20201212 add
BAL_CONFIG="${PWD}/files/rk3399/r08/balance_irq"
...
BOOTFILES_HOME="${PWD}/files/bootfiles/rockchip/rk3399/r08"
GET_RANDOM_MAC="${PWD}/files/get_random_mac.sh"
BOOTLOADER_IMG="${PWD}/files/rk3399/r08/uboot-r08.bin"
...
# 20220927 add
BOARD_HOME="${PWD}/files/rk3399/r08/board.d"
# 20221001 add
MODULES_HOME="${PWD}/files/rk3399/modules.d"
# 20221123 add
BOARD_MODULES_HOME="${PWD}/files/rk3399/r08/modules.d"
# 20221013 add
